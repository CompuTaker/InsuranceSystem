  ...
  <tr>
   ...
   <table>
    ...
    <tr>
      ...
      <td><textarea name="injuryCoverage" cols="50" rows="13"></textarea></td>
      <td>&nbsp;</td>
     </tr>
      <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
    <tr>
      ...
      <td><input name="RiskRateByGender" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
     </tr>
     <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
     <tr>
      ...
      <td><input name="RiskRateByIllHistory" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
     </tr>
     <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
     <tr>
      ...
      <td><input name="RiskRateByJob" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
     </tr>
     <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
     <tr>
      ...
      <td align="center">나이에 따른 위험률</td>
       <td><input name="RiskRateByAge" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
     </tr>
