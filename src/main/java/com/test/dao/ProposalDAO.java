...
public interface ProposalDAO {
	 ...
	 * @param ����������
	 */
	public int requestInternalApproved(Proposal proposal, List<File> VerificationDocumentList);
	 ...
	 * @param ����������
	 */
	public int requestExternalApproved(Proposal proposal, List<File> VerificationDocumentList);
