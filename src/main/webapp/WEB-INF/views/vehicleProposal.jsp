				...
				<td>
					...
					<table>
						...
						<tr>
							...
							<td>
								<input name="vehiclePurpose" size="50" maxlength="50">
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr height="1" bgcolor="#dddddd">
						...
						<tr>
							...
							<td>
								<input name="extraChargeRate" size="50" maxlength="50">
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr height="1" bgcolor="#dddddd">
						...
						<tr>
							...
							<td>
								<input name="noAccidentDiscountRate" size="50" maxlength="50">
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr height="1" bgcolor="#dddddd">
						...
						<tr>
							...
							<td>
								<textarea name="vehicleTypeConstant" cols="50" rows="13"></textarea>
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr height="1" bgcolor="#dddddd">
